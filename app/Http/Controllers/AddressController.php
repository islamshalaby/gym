...
class AddressController extends Controller
{
    ...
    {
        $this->middleware('auth:api' , ['except' => ['getdeliveryprice' , 'getareas', 'getgovernment']]);
    }
    ...
    public function getgovernment(Request $request){
        ...
        $data = Governorate::where('deleted' , 0)->select('id', 'title_'.$request->lang.' as title')->with('areas')->get();
