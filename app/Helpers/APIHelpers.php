<?php
    ...
    class APIHelpers {
        ...
        public static function send_notification($title , $body , $image , $data , $token){
            ...
            $server_key="AAAAsKub-RU:APA91bFpZMibT4R-MTwlbIMYXDJB4ALHjf06SHFgA0ji-416L65Q-s2BWa9Y6u8M0s-T2leAwibdwTve2IxQgoQB3AS2pYs4BLucrohEVB0xCrfE9pCDfIZKcvY1qQCgiRkJLrzIWyIA";
        ...
        public static function send_chat_notification($tokens, $title="hello", $msg="helo msg", $type=1,$chat=null,$link=null){
            $key = 'AAAAsKub-RU:APA91bFpZMibT4R-MTwlbIMYXDJB4ALHjf06SHFgA0ji-416L65Q-s2BWa9Y6u8M0s-T2leAwibdwTve2IxQgoQB3AS2pYs4BLucrohEVB0xCrfE9pCDfIZKcvY1qQCgiRkJLrzIWyIA';
            $fields = array
            (
