...
use Illuminate\Http\Request;
    ...
    */
    ...
    Route::get('/shop/offer/products/{id}/{lang}/{v}' , 'ShopsController@offer_products')->middleware('checkguest');
...
//    coach - panel ----------------------------------------------------------------------------------------------------------------
    ...
    Route::get('coach/media/filter/{type}/{lang}/{v}' , 'CoachesController@media_filter');
    ...
    Route::post('/coach/chat/end_consultation/{lang}/{v}' , 'CoachChatController@end_consultation');

    Route::get('coach_notifications/{lang}/{v}' , 'CoachesController@notifications');
